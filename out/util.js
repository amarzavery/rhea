...
exports.uuid4 = uuid4;
function uuid_to_string(buffer) {
    if (buffer.length === 16) {
...
exports.and = and;
;
function is_sender(o) { return o.is_sender(); }
exports.is_sender = is_sender;
;
function is_receiver(o) { return o.is_receiver(); }
exports.is_receiver = is_receiver;
;
function sender_filter(filter) { return and(is_sender, filter); }
exports.sender_filter = sender_filter;
;
function receiver_filter(filter) { return and(is_receiver, filter); }
exports.receiver_filter = receiver_filter;
;
function is_defined(field) {
